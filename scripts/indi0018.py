...
class EvoCNNModel(nn.Module):
    ...
    def forward(self, x):
        ...
        out_1 = self.conv_64_256(out_0)
        out_2 = self.conv_256_128(out_1)
        out_3 = self.conv_128_256(out_2)
        out_4 = self.conv_256_256(out_3)
        out_5 = self.conv_256_256(out_4)
        out_6 = self.conv_256_128(out_5)
        out_7 = F.avg_pool2d(out_6, 2)
        out_8 = self.conv_128_256(out_7)
        out_9 = self.conv_256_64(out_8)
        out_10 = F.max_pool2d(out_9, 2)
        out_11 = self.conv_64_64(out_10)
        out_12 = self.conv_64_64(out_11)
        out_13 = self.conv_64_128(out_12)
        out_14 = F.max_pool2d(out_13, 2)
        out = out_14
