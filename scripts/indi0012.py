...
class EvoCNNModel(nn.Module):
    def __init__(self):
        ...
        #conv unit
        self.conv_3_64 = BasicBlock(in_planes=3, planes=64)
    ...
    def forward(self, x):
        out_0 = self.conv_3_64(x)
        out_1 = self.conv_64_64(out_0)
        out_2 = self.conv_64_256(out_1)
        out_3 = self.conv_256_256(out_2)
        out_4 = self.conv_256_64(out_3)
        out_5 = self.conv_64_128(out_4)
        out_6 = self.conv_128_256(out_5)
        out_7 = F.max_pool2d(out_6, 2)
        out_8 = self.conv_256_64(out_7)
        out_9 = F.avg_pool2d(out_8, 2)
        out_10 = self.conv_64_64(out_9)
        out_11 = self.conv_64_256(out_10)
        out_12 = F.avg_pool2d(out_11, 2)
        out_13 = self.conv_256_256(out_12)
        out_14 = self.conv_256_64(out_13)
        out_15 = self.conv_64_128(out_14)
        out_16 = self.conv_128_64(out_15)
        out = out_16
