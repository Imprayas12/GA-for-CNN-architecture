...
class EvoCNNModel(nn.Module):
    ...
    def forward(self, x):
        ...
        out_2 = self.conv_256_64(out_1)
        out_3 = self.conv_64_128(out_2)
        out_4 = self.conv_128_64(out_3)
        out_5 = self.conv_64_256(out_4)
        out_6 = self.conv_256_256(out_5)
        out_7 = self.conv_256_64(out_6)
        out_8 = F.max_pool2d(out_7, 2)
        out_9 = self.conv_64_64(out_8)
        out_10 = F.max_pool2d(out_9, 2)
        out_11 = self.conv_64_64(out_10)
        out_12 = F.max_pool2d(out_11, 2)
        out_13 = self.conv_64_128(out_12)
        out_14 = self.conv_128_64(out_13)
        out_15 = self.conv_64_64(out_14)
        out = out_15
