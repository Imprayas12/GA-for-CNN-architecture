...
class EvoCNNModel(nn.Module):
    ...
    def forward(self, x):
        ...
        out_1 = self.conv_256_128(out_0)
        out_2 = self.conv_128_256(out_1)
        out_3 = self.conv_256_256(out_2)
        out_4 = F.avg_pool2d(out_3, 2)
        out_5 = self.conv_256_256(out_4)
        out_6 = self.conv_256_64(out_5)
        out_7 = self.conv_64_64(out_6)
        out_8 = self.conv_64_64(out_7)
        out_9 = self.conv_64_256(out_8)
        out_10 = self.conv_256_128(out_9)
        out_11 = F.avg_pool2d(out_10, 2)
        out_12 = self.conv_128_256(out_11)
        out_13 = self.conv_256_256(out_12)
        out_14 = self.conv_256_128(out_13)
        out_15 = F.max_pool2d(out_14, 2)
        out = out_15
