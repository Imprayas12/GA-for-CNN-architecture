...
class EvoCNNModel(nn.Module):
    ...
    def forward(self, x):
        ...
        out_6 = self.conv_128_64(out_5)
        out_7 = self.conv_64_256(out_6)
        out_8 = F.avg_pool2d(out_7, 2)
        out_9 = self.conv_256_64(out_8)
        out_10 = self.conv_64_256(out_9)
        out_11 = F.max_pool2d(out_10, 2)
        out_12 = self.conv_256_128(out_11)
        out_13 = self.conv_128_64(out_12)
